...
exports.new = async (name) => {
  ...
  await generateModel.new('user', { properties: 'firstname:string,age:number', methods: 'comparePassword', hooks: 'pre.save.crypto,pre.findOneAndUpdate.crypto,pre.findOneAndUpdate.addDate' }, projectPath);
  ...
  await generateService.new('cryptPassword', { modules: 'bcrypt,config' }, projectPath);
